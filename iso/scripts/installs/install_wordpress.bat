...
copy E:\resources\wordpress\update_ip.ps1 "C:\Program Files\wordpress\update_ip.ps1"
cmd /c ""C:\Program Files\7-Zip\7z.exe" x E:\resources\wordpress\wordpress.zip -oC:\wamp\www\"
